...
```
┌──(kali㉿kali)-[/media/sf_almacenamientoCompartido/T04_Crypto/sub1]
└─$ cat message.txt 
...
Como vemos, es otro mensaje encriptado con nuestra flag, pero esta vez no nos dan la key de desencriptación.

Entonces, usaremos una [herramienta online](https://quipqiup.com/) para obtener el texto desencriptado, el cual es este:
```
