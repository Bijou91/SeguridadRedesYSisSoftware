...
## Solución
Lo primero que haremos es analizar el código:
```python
import sys
...
Al analizar el código, podemos notar que podemos ingresar el nombre de la función que queramos, y si notamos que la función 'win' contiene la flag, entonces la ingresamos al conectarnos al servidor:
```
┌──(kali㉿kali)-[/media/sf_almacenamientoCompartido/Reversing02/p1]
└─$ nc saturn.picoctf.net 57201
...
Como vemos, es una cadena en hexadecimal que debemos convertir, y si usamos Cyberchef obtenemos nuestra flag
