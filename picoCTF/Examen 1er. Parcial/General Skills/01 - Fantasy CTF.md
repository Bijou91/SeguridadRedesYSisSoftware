## Fantasy CTF
# Descripción
Play this short game to get familiar with terminal applications and some of the most important rules in scope for picoCTF. Connect to the program with netcat: `$ nc verbal-sleep.picoctf.net 56304`
# Solución
Utilizar la webshell y conectarnos a la página dada, después avanzar en las opciones que nos muestran hasta obtener la flag
