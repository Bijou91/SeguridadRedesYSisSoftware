...
## Solución
Como trabajaremos con un archivo de captura de paquetes, utilizaremos wireshark para este reto.

Al abrir el archivo, utilizaremos la llave que nos entrega el reto.
Llave:
```
-----BEGIN PRIVATE KEY-----
...
```
┌──(kali㉿kali)-[/media/sf_almacenamientoCompartido/15_Forensic3/webnet1]
