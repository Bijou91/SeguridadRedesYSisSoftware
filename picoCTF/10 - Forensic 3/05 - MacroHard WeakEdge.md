...
## Solución
El reto nos proporciona un archivo powerpoint de 2007, pero al igual que en el reto de las muñecas matryoshka, es un archivo zip disfrazado, así que lo descomprimimos
```
┌──(kali㉿kali)-[/media/sf_almacenamientoCompartido/15_Forensic3/macrohard]
...
Como podemos ver en ese último archivo descomprimido, se descomprimió un archivo llamado 'hidden' dentro de ppt y slideMasters
```
┌──(kali㉿kali)-[/media/sf_almacenamientoCompartido/15_Forensic3/macrohard]
└─$ cd ppt/slideMasters 
                                                                                                                                                                      
┌──(kali㉿kali)-[/media/…/15_Forensic3/macrohard/ppt/slideMasters]
└─$ ls
...
Este archivo contiene un string codificado en base64, así que lo vamos a descifrar:
```
┌──(kali㉿kali)-[/media/…/15_Forensic3/macrohard/ppt/slideMasters]
